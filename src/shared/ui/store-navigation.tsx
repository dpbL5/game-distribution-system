...
export function StoreNavigation({ user }: { user: NavigationUser }) {
  ...
  const links = desktopLinks[role] as readonly { href: string; label: string; icon: typeof House }[];
  const mobile = mobileLinks[role] as readonly { href: string; label: string; icon: typeof House }[];
